---
name: base-wallet
description: Create and manage Base chain wallets for AI agents. Use when an agent needs to create a new Ethereum/Base wallet, sign messages (SIWE), or check wallet balance. Supports programmatic wallet creation without browser extensions or human intervention. Integrates with BaseMail.ai for email identity.
---
